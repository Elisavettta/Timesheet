...
// тут стоял home,теперь homecatalog
...
struct SignIn : View {
    ...
    var body : some View{
        ZStack {
            ...
            VStack {
                VStack{
                    Text("Sign In").fontWeight(.heavy).foregroundColor(Color(hue: 0.412, saturation: 0.796, brightness: 0.477)).font(.largeTitle).padding([.top,.bottom], 20)
                        ...
                        VStack(alignment: .leading){
                            ...
                            HStack{
                                ...
                                if user != ""{
                                    ...
                                    Image("images").foregroundColor(Color.init(.label))
                                }
...
struct SignUp : View {
    ...
    var body : some View{
     ...
     /*   ZStack {
            Image ("") // bhbhbhblkhbjbhvkgcchckghhv
                .resizable()
                .edgesIgnoringSafeArea(.all) */
            VStack{
